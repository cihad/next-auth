...
import { useAppDispatch, useAppSelector } from "@fakestore/shared/store/hooks";
import {
  removeItem,
  updateQuantity,
  selectCartItems,
  selectTotalItems,
  selectTotalPrice,
} from "@fakestore/shared/store/cart-slice";
...
import { Minus, Plus, ShoppingCart, Trash2Icon } from "lucide-react";
